...
public class PhysicalResistanceLevelModifier : PhysicalResistanceModifier
{
    private int _level;
    ...
    public override PhysicalResistanceModifierType Type => PhysicalResistanceModifierType.LEVEL;

    public PhysicalResistanceLevelModifier(int level, float healthPerLevel)
    {
        Level = level;
